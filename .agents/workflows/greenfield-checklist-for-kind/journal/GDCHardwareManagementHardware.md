...
| :--- | :--- | :---: | :----------: | :----: | :----------: | :------------: |
| 1 | Direct API Types and Identity | [#10269](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/10269) | [#10330](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/10330) | `Open` (Assigned `ada-coder-bot`, `lovelace-coder-bot`) | 2026-07-02 | |
