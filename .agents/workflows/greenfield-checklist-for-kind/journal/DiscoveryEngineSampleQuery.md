...
## Current Step
**Step 1: Direct API Types and Identity and Reference Types Pattern** (Status: PR Created - CI checks failing on out-of-date CRD reports and missing pluralization exception, assigned back to author bot)
