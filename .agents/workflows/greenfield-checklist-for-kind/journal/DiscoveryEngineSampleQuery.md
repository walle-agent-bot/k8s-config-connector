...
## Current Step
**Step 1: Direct API Types and Identity and Reference Types Pattern** (Status: CI Checks Running)

## Migration Progress

| Step | Step Name | GitHub Issue | GitHub PR | Status | Date Started | Date Completed |
|---|---|---|---|---|---|---|
| 1 | Direct API Types & Identity | [#9239](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/9239) | [#11390](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/11390) | CI Checks Running | 2026-07-06 | - |
